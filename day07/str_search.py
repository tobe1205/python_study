...
# 확장자 추출 - 맨 뒤에 있는 . 다음글자부터 끝까지 슬라이싱
...
if user_pw.find('!') == -1:
    print('비밀번호에 !를 입력해주세요')
else:
    print('사용가능한 패스워드입니다.')

# count(): 문자열 내부에 찾는 단어의 출현횟수를 변환
...
# 특정 문자가 문자열에 안에 포함되었는지의 유무만 확인

st = 'hello 안녕 내이름은 뽀로로야~'
